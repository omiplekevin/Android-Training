...
public class Utility {
	 ...
	 * 
	 * 1 - Connected to network only - NO Internet access 2 - Both connected to
	 * network and has Internet access 0 - Not connected to any network and no
	 * Internet access. Enable device radio module to connect to available
	 * networks.
	 * 
	 * @param context
