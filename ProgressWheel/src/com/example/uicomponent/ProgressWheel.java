...
import com.example.progresswheel.R;
...
public class ProgressWheel extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(circleBounds, -90, 270, false, circlePaint);
        //Draw the rim
        canvas.drawArc(circleBounds, -90, 270, false, rimPaint);
        canvas.drawArc(circleOuterContour, -90, 270, false, contourPaint);
        canvas.drawArc(circleInnerContour, -90, 270, false, contourPaint);
        //Draw the bar
        if (isSpinning) {
    ...
    */
    ...
    /**
     * Increment the progress by 1 (of 180)
     */
    public void incrementProgress() {
        ...
        if (progress > 180)
            progress = 0;
//        setText(Math.round(((float) progress / 180) * 100) + "%");
       postInvalidate();
    }
