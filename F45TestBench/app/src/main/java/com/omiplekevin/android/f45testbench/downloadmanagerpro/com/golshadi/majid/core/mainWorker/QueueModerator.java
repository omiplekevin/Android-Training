...
import com.omiplekevin.android.f45testbench.downloadmanagerpro.com.golshadi.majid.Utils.QueueObserver;
    ...
    public void startQueue() {
        ...
        if (uncompletedTasks != null) {
            ...
            while (uncompletedTasks.size() > 0 &&
                ...
                Log.d("QueueModerator", "startQueue: saving to " + task.save_address);
                Thread downloader =
