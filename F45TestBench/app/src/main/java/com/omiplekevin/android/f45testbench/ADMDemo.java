...
public class ADMDemo extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadManager = new DownloadManager(ADMDemo.this);
        //TEMPORARY!!!!
        ...
        startDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                downloadItemList = new ArrayList<DownloadEvent>(){{
                    add(new DownloadEvent("https://s3-eu-west-1.amazonaws.com/f45fm/mixes/c7I1DrPHSZSspWkxIV6S_2%20am%20Anthems_DJ%20Chris%20Dominick_June%209%202017.mp3", OVERWRITE, true));
                }};
                downloadManager.addAllFiles(downloadItemList);
                downloadManager.prepareFiles();
